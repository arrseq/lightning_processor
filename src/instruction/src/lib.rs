...
pub const DRIVER0_DESTINATION_DYNAMIC: u8 = 0b000000_0_1;
...
impl Driver {
    /// Extract instruction driver parameters.
    /// ```
    /// use em_instruction::Driver;
    /// 
    /// 
    ...
    /// First 6 bits of the extension code are use for.
    /// ```
    /// use em_instruction::Driver;
    /// 
    ...
    pub fn set_extension(driver0: u8, extension: u8) -> u8 {
        let extension_layer = (0b00_111111 & extension) << 2;
        (driver0 & !DRIVER0_EXTENSION_MASK) | extension_layer
    }
}
