use thiserror::Error;
use crate::instruction_lg::operand::presence::Combination;
...
impl From<Combination> for Encoded {
    fn from(value: Combination) -> Self {
        match value {
            Combination::Destination(_)
            | Combination::SingleInput(_) => Self::Single,
            Combination::DualInput(_)
            | Combination::DestinationAndInput(_) => Self::Dual,
            Combination::All(_) => Self::Triple
        }
    }
}
